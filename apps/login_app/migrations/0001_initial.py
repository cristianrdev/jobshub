    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_name', models.CharField(max_length=50, validators=[apps.login_app.models.ValidarLongitudMinima])),
                ...
                ('match', models.CharField(blank=True, max_length=10)),
                ('match_proportion', models.CharField(blank=True, max_length=10)),
                ('skills_number', models.CharField(blank=True, max_length=50)),
