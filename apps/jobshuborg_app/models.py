...
class Position(models.Model):
    ...
    position_language = models.ForeignKey(Language, blank=True, null=True ,related_name="language_position", on_delete = models.CASCADE)
    position_framework = models.ForeignKey(Framework, blank=True, null=True ,related_name="framework_position", on_delete = models.CASCADE)
